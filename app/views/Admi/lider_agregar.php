        ...
        <form action="" method="POST">
            ...
            <div class="form-row">
                ...
                <div class="col-sm-4">
                    ...
                    <input type="tel" class="form-control" placeholder="55-12-34-56-78" required name="phone" data-toggle="tooltip" data-placement="left" title="Inserta tu número en el siguiente formato: 55-11-22-33-44" data-toggle="tooltip" data-placement="left" title="Inserta tu número en el siguiente formato: 55-11-22-33-44" pattern="[0-9]{2}-[0-9]{2}-[0-9]{2}-[0-9]{2}-[0-9]{2}" required name="phone">
                </div>

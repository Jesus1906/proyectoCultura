        ...
        <form action="" method="POST">
            ...
            <div class="form-row">
                ...
                <div class="col-sm-4">
                    ...
                    <input type="text" class="form-control" placeholder="Apellido Paterno" required name="firstLastName">
                </div>
                <div class="col-sm-4">
                    <label for="inputState"> Apellido Materno</label>
                    <input type="text" class="form-control" placeholder="Apellido Materno" required name="secondLastName">
                </div>
            </div>
            ...
            <div class="form-row">
                ...
                <div class="col-sm-4">
                    ...
                    <input type="tel" class="form-control" id="phone" placeholder="55-12-34-56-78" data-toggle="tooltip" data-placement="left" title="Inserta tu número en el siguiente formato: 55-11-22-33-44" pattern="[0-9]{2}-[0-9]{2}-[0-9]{2}-[0-9]{2}-[0-9]{2}" required name="phone">
                </div>
                <div class="col-sm-4">
            ...
            <div class="form-row">
                ...
                <div class="col-sm-4">
                    ...
                    <input type="password" class="form-control" placeholder="Debe contener minimo 8 digitos" required id="contraseña" name="password" minlength="8" maxlength="20">
                </div>
                <div class="col-sm-4">

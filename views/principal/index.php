...
<head>
    ...
    <!-- Style -->
    <link rel="stylesheet" type="text/css" href="http://localhost/proyectoCultura/views/principal/styles.css">
...
<body>
    <nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="#inicio">
            <img src="http://localhost/proyectoCultura/ImagenescULTURA/logo.jpg" width="30" height="30" class="d-inline-block align-top" alt="" loading="lazy">
                ...
                <div id="carouselExampleIndicators1" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="http://localhost/proyectoCultura/ImagenescULTURA/Inscripciones.jpg" class="d-block w-100" style="height: 600px; width: 300px;">
                        </div>
                        <div class="carousel-item">
                            <img src="http://localhost/proyectoCultura/ImagenescULTURA/70008709_2501561010074382_6545377534010440019_n.jpg" class="d-block w-100" style="height: 600px; width: 300px;">
                        </div>
